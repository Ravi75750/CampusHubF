...
export default function FeedPage() {
  ...
  async function handleCreatePost(e) {
    ...
    if (!newPost.text.trim() || isPosting) return;
          ...
          <div className="relative w-full max-w-lg bg-white dark:bg-[#1a1d24] rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <div className="p-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
              ...
              <button
                ...
                disabled={!newPost.text.trim() || isPosting}
                className={`flex items-center gap-2 px-6 py-2 rounded-full font-semibold text-sm transition-all ${newPost.text.trim() && !isPosting
